...
| **EconomicMemory** | Append-only ledger; **only audited recorder contracts can write** — self-report is impossible by construction | `0x9913A072915EF382b680bb4a0ff3CD8373490C4D` |
